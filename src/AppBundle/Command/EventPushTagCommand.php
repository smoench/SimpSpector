...
class EventPushTagCommand extends AbstractCommand
{
    /**
     *
     */
    ...
    {
        $this
            ->setName('simpspector:event:push-tag')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $event             = new PushEvent();
        $event->type       = PushEvent::TYPE_TAG;
        $event->tagName    = $helper->getRandomVersionNumber();
